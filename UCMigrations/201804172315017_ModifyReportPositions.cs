namespace DAL.UCMigrations
{
    ...
    public partial class ModifyReportPositions : DbMigration
    {
 ...
 SELECT CASE WHEN[dbo].HasComponentAnyParentBasedOnCompart(tid.track_unit_auto) = 0 THEN
      ...
      lct.sorder, lc.comparttype_auto,
		...
		(CASE WHEN(lc.comparttype_auto = 233 OR lc.comparttype_auto = 234) AND tu.pos = 1 THEN 'Front' 
             ...
             WHEN lc.comparttype_auto = 230 OR lc.comparttype_auto = 231 OR lc.comparttype_auto = 232   OR lc.comparttype_auto = 237 OR lc.comparttype_auto = 240 THEN ' '

             WHEN lc.comparttype_auto = 236 AND ( tu.pos = 0 OR tu.pos = 1)THEN ' '
