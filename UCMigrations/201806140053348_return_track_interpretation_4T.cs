namespace DAL.UCMigrations
{
    ...
    public partial class return_track_interpretation_4T : DbMigration
    {
        public override void Up()
        {
            Sql(@"
/****** Object:  StoredProcedure [dbo].[return_track_interpretation_4T]    Script Date: 14/06/2018 9:41:12 AM ******/
SET ANSI_NULLS ON
GO
...
");
        ...
        {
            Sql(@"/****** Object:  StoredProcedure [dbo].[return_track_interpretation_4T]    Script Date: 14/06/2018 9:44:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
begin
	...
	select distinct ti.inspection_auto, cust.cust_name, eq.serialno,ti.inspection_date , ti.evalcode, case when ti.released_date is null then 0 else 1 end as released, ti.eval_comment,eq.unitno
	into #tTB_rtn_track_inp
	from 
		EQUIPMENT eq
		inner join LU_MMTA mmta on eq.mmtaid_auto = mmta.mmtaid_auto
...
begin
	...
	select distinct ti.inspection_auto, cust.cust_name, equip.serialno,ti.inspection_date , ti.evalcode, case when ti.released_date is null then 0 else 1 end as released, ti.eval_comment,equip.unitno
	into #tTB_rtn_track_inp2
	from 
		EQUIPMENT equip
		inner join LU_MMTA mmta on equip.mmtaid_auto = mmta.mmtaid_auto
